...
const Footer = () => {
    return (<div id="contact" className="bg-black flex flex-col w-screen">
        ...
        <div className="h-[calc(100vh-280px)] w-full">
            <div className="bg-black bottom-0 fixed flex flex-col gap-8 h-[calc(100vh-280px)] items-center justify-center text-gray-300 w-full px-8">
                <h1>Visit & Contact Us</h1>
                <div className="flex flex-col sm:items-center gap-2 text-xl">
                    <div className="flex gap-2 items-center"><LuMapPin className="text-2xl" />Address: 5,Jalan Rosmerah 2/5, Johor Bahru, Malaysia</div>
                ...
                <div className="flex gap-8 text-2xl sm:text-4xl">
                ...
                <span className="text-gray-500 text-sm">Imcreator 2024 All Rights Reserved ©</span>
            </div>
        </div>
    </div>)
}
